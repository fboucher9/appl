...
#if defined INC_APPL_MODULE_SERVICE_H
#error include appl_module_service.h once
#endif /* #if defined INC_APPL_MODULE_SERVICE_H */

#define INC_APPL_MODULE_SERVICE_H
